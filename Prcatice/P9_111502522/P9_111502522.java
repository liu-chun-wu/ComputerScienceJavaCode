 ...
 */
package P9_111502522;

import java.util.Scanner;
import java.util.ArrayList;

public class P9_111502522 {
        ...
        while (true) {
            ...
            switch (command) {
                case "0":
                    ...
                    return;
                case "1":
                    System.out.print("Total number of tokens: ");
                    System.out.println(Token_list.size());
                    break;
                case "2":
                    for (int i = 0; i < Token_list.size(); i++) {
                        System.out.print("[");
                        System.out.print(Token_list.get(i).return_token());
                        System.out.println("]");
                    }
                    break;
                case "3":
                    System.out.print("Identifier: ");
                    System.out.print(Identifier_count);
                    System.out.print(", Number: ");
                    System.out.print(Number_count);
                    System.out.print(", Special Symbol: ");
                    System.out.println(Special_Symbol_count);
                    break;
                default:
